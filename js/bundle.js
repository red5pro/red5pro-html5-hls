...
var FormHandler = (function () {
  function FormHandler(form, submit) {
    ...
    this.fields = Array.prototype.slice.call(inputs).map(function (x) {
      return new FormField(x);
    });
    this.form = form;
    this.hasSaved = false;
    this.submit = submit;
...
},{"./form-field.js":1}],3:[function(require,module,exports){
'use strict';
...
require('babel-polyfill');(function () {
  ...
  var FormHandler = require('./form-handler.js');
  var VideoHandler = require('./video-handler.js');

  function onDomContentLoaded(e) {
    var form = document.getElementById('stream-settings-form');
    var submit = document.getElementById('stream-settings-form-submit');

    var formHandler = new FormHandler(form, submit); // eslint-disable-line no-unused-vars

    var video = document.getElementById('demo-vid');
    var videoHandler = new VideoHandler(video); // eslint-disable-line no-unused-vars

    videoHandler.addSource('http://54.86.109.160:5080/live/hls/stream.m3u8', VideoHandler.HLSType()).then(function () {
...
},{"./form-handler.js":2,"./video-handler.js":4,"babel-polyfill":5}],4:[function(require,module,exports){
'use strict';
